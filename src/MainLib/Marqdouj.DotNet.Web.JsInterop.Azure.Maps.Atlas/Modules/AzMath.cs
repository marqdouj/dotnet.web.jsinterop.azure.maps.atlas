...
namespace Marqdouj.DotNet.Web.JsInterop.Azure.Maps.Atlas.Modules
{
    ...
    internal class AzMath(Lazy<Task<IJSObjectReference>> moduleTask) : IAtlasMath
    {
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<Polygon>>(GetJsInteropMethod(), bboxes);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), accelerations, fromUnits, toUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), areas, fromUnits, toUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), distances, fromUnits, toUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), speeds, fromUnits, toUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), timespan, fromUnits, toUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), initialSpeed, distance, timespan, speedUnits, distanceUnits, timeUnits, accelerationUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), origin, destination, timestampProperty, speedProperty, speedUnits, accelerationUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), initialSpeed, finalSpeed, timespan, speedUnits, timeUnits, accelerationUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<List<double>>>(GetJsInteropMethod(), source, target, targetPoints, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<List<double>>>(GetJsInteropMethod(), source, target, sourcePoints, decimals);
        }

        public async ValueTask<List<double>> GetArea(IEnumerable<object> data, AreaUnits? areaUnits = null, int? decimals = null)
        {
            return await moduleTask.InvokeAsyncInternal<List<double>>(GetJsInteropMethod(), data, areaUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), positions, tension, nodeSize, close);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<Feature<Point, DistanceProperties>>(GetJsInteropMethod(), pt, geom, units, decimals);
        }

        public async ValueTask<Polygon> GetConvexHull(object data)
        {
            return await moduleTask.InvokeAsyncInternal<Polygon>(GetJsInteropMethod(), data);
        }
        
        public async ValueTask<Position> GetDestination(object origin, double heading, double distance, DistanceUnits? units = null)
        {
            return await moduleTask.InvokeAsyncInternal<Position>(GetJsInteropMethod(), origin, heading, distance, units);
        }

        public async ValueTask<double> GetDistanceTo(object origin, object destination, DistanceUnits? units = null)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), origin, destination, units);
        }

        public async ValueTask<double> GetEarthRadius(DistanceUnits? units = null)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), units);
        }

        public async ValueTask<List<Position>> GetGeodesicPath(object path, double? nodeSize = null)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), path, nodeSize);
        }

        public async ValueTask<List<List<Position>>> GetGeodesicPaths(object path, double? nodeSize = null)
        {
            return await moduleTask.InvokeAsyncInternal<List<List<Position>>>(GetJsInteropMethod(), path, nodeSize);
        }

        public async ValueTask<double> GetHeading(object origin, object destination)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), origin, destination);
        }

        public async ValueTask<double> GetLengthOfPath(object path, DistanceUnits? units = null)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), path, units);
        }

        public async ValueTask<List<Position>> GetPathDenormalizedAtAntimerian(object path)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), path);
        }

        public async ValueTask<List<List<Position>>> GetPathSplitByAntimeridian(object path)
        {
            return await moduleTask.InvokeAsyncInternal<List<List<Position>>>(GetJsInteropMethod(), path);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<Feature<Point, HeadingProperties>>(GetJsInteropMethod(), path, distance, units);
        }

        public async ValueTask<List<Feature<Point, HeadingProperties>>> GetPointsWithHeadingAlongPath(object path, double distance)
        {
            return await moduleTask.InvokeAsyncInternal<List<Feature<Point, HeadingProperties>>>(GetJsInteropMethod(), path, distance);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<Position>(GetJsInteropMethod(), path, distance, units);
        }

        public async ValueTask<List<Position>> GetPositions(object data)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), data);
        }

        public async ValueTask<List<Position>> GetPositionsAlongPath(object path, double numPositions)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), path, numPositions);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), origin, radius, numberOfPositions, units, offset);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<List<List<Position>>>(GetJsInteropMethod(), origin, radius, numberOfPositions, units, offset);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), origin, destination, timespan, timeUnits, speedUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), origin, destination, timestampProperty, speedUnits, decimals);
        }
        ...
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), distanceUnits, timespan, speed, acceleration, timeUnits, speedUnits, accelerationUnits, decimals);
        }

        public async ValueTask<Position> Interpolate(object origin, object destination, double? fraction = null)
        {
            return await moduleTask.InvokeAsyncInternal<Position>(GetJsInteropMethod(), origin, destination, fraction);
        }

        public async ValueTask<List<Position>> MercatorPixelsToPositions(object pixels, double zoom)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), pixels, zoom);
        }

        public async ValueTask<List<Pixel>> MercatorPositionsToPixels(object positions, double zoom)
        {
            return await moduleTask.InvokeAsyncInternal<List<Pixel>>(GetJsInteropMethod(), positions, zoom);
        }

        public async ValueTask<double> NormalizeLatitude(double lat)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), lat);
        }

        public async ValueTask<double> NormalizeLongitude(double lng)
        {
            return await moduleTask.InvokeAsyncInternal<double>(GetJsInteropMethod(), lng);
        }

        public async ValueTask<List<Position>> RotatePositions(object positions, object origin, double angle)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod(), positions, origin, angle);
        }

        public async ValueTask<List<Position>> SimplifyPositions(object points, double tolerance)
        {
            return await moduleTask.InvokeAsyncInternal<List<Position>>(GetJsInteropMethod("Simplify"), points, tolerance);
        }

        public async ValueTask<List<Pixel>> SimplifyPixels(object points, double tolerance)
        {
            return await moduleTask.InvokeAsyncInternal<List<Pixel>>(GetJsInteropMethod("Simplify"), points, tolerance);
        }
